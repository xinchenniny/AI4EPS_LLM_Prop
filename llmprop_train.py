...
if __name__ == "__main__":
    ...
    # 禁用 Hugging Face 自动下载模型，确保只使用本地模型文件
    ...
    if tokenizer_name == 't5_tokenizer': 
        ...
        tokenizer = AutoTokenizer.from_pretrained("/home/chentao/zxc/LLM-Prop/models--google--t5-v1_1-small")
    ...
    # define the model
    base_model = T5EncoderModel.from_pretrained("/home/chentao/zxc/LLM-Prop/models--google--t5-v1_1-small/blobs")
